...
export const knight_couch_1 = { w: 28, x: 0, url, y: 56, h: 19, };
export const knight_2_ride_1 = { w: 28, x: 0, url, y: 75, h: 19, };
...
export const knight_2_hit = { w: 14, x: 56, url, y: 75, h: 16, };
